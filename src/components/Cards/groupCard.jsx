...
//         </p>
//         <button className="join-button bg-NavClr px-5 py-1 rounded-md text-white text-sm hover:bg-red-600 transition-colors">
//           Join group
//         </button>
//       </div>
//     </div>
...
//           `${backendURL}/api/groups/getAllGroups`
//         );
  ...
  <Link
    ...
    <div className="card bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="card-content p-4">
        <h3 className="text-lg font-semibold mb-2">{name}</h3>
        <p className="text-sm text-gray-600 mb-2">
          {members.length || members} Member{members !== 1 ? "s" : ""} - 0 Posts
          today
        </p>
